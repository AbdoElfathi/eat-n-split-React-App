...
export default function App() {
  ...
  const handleAddFiend = (friend) => {
    setFriends((frn) => [...frn, friend]);
    setShowAddFriend(false);
  };

  const [selectedFriend, setSelectedFriend] = useState(null);
  const hadnleSelectedFriend = (friend) => {
  ...
  return (
    <div className="app">
      <div className="sidebar">
        <FriendsList
          onSelectFriend={hadnleSelectedFriend}
          selectedFriend={selectedFriend}
          friends={friends}
        />
        {showAddFriend && <FormAddFriend onAddFriend={handleAddFiend} />}
